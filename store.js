...
const createInitialState = () => ({
  ...
  searchResults: [],
  featuredTracks: [],
  homeSections: [],   // { genre: string, tracks: Track[] }[]
  isLoading: false,
  isSearching: false,
  error: null,
  dominantColor: {
...
class Store {
  ...
  #reduce(state, action) {
    switch (action.type) {
      ...
      case ACTION.SET_HOME_SECTIONS:
        return { ...state, homeSections: action.payload };

      case ACTION.SET_LOADING:
        return { ...state, isLoading: action.payload };

      case ACTION.SET_SEARCHING:
